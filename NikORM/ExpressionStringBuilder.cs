    ...
    public sealed class ExpressionStringBuilder : ExpressionVisitor
    {
        ...
        private void OutMember(Expression instance, MemberInfo member)
        {
            ...
            else
            {
                ...
                if (member.DeclaringType != null) Out(member.DeclaringType.Name + "." + member.Name);
            }
        }
        ...
        protected override CatchBlock VisitCatchBlock(CatchBlock node)
        {
            ...
            {
                Out(string.IsNullOrEmpty(node.Variable.Name) ? string.Empty : node.Variable.Name);
            }
            Out(") { ... }");
            return node;
        }
        ...
        protected override Expression VisitIndex(IndexExpression node)
        {
            ...
            else
            {
                ...
                if (node.Indexer.DeclaringType != null) Out(node.Indexer.DeclaringType.Name);
            }
